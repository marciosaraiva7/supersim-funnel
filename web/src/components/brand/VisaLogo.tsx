...
/**
 * Visa Brand Mark — paths based on the official wordmark geometry (#1434CB).
 * @see https://brand.visa.com
 */
...
export function VisaLogo({ height = 20, className, variant = 'white' }: VisaLogoProps) {
  const fill = variant === 'white' ? '#FFFFFF' : '#1434CB'
